      ...
      <Navbar variant="dark" expand="lg" bg="dark" className="navbar-transparent navbar-theme-primary sticky-top">
        <Container className="position-relative justify-content-between px-3">
          <Navbar.Brand as={HashLink} to="#home" className="me-lg-3 d-flex align-items-center">
            <Image src={ReactHero} />
            <span className="ms-2 brand-text d-none d-md-inline">Beyond Inc.</span>
          </Navbar.Brand>
        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">Beyond Inc. Dashboard</h1>
        ...
        <Container>
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <p className="mb-4">Beyond Inc. is an admin dashboard template that is built using React.js components using react hooks and a data-driven structure that can kick-start your app in no time.</p>
  ...
  <Button variant="primary" className="m-1">Primary</Button>
          ...
          <Row className="justify-content-between align-items-center">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <p className="mb-4">
                Beyond Inc. is built using the latest version of Bootstrap 5 and we only used Vanilla Javascript for everything including the plugins
              </p>
            </Col>
        ...
        <Container>
          <Row>
            <Col xs={12} lg={8}>
              ...
              <p className="lead mb-4 me-lg-6">Do you want to take React development to the next level? Check out the premium version of Beyond Inc. Dashboard in the following comparison table.</p>
            </Col>
            <Col xs={12} lg={4}>
          ...
          <Row className="mt-6">
            ...
            <Col xs={12} md={6} lg={4} className="mb-5 mb-lg-0">
              <Card border="light" className="p-4 py-5 mt-lg-n5">
                ...
                <Button href="https://demo.themesberg.com/volt-pro-react/#/" target="_blank" variant="secondary" className="w-100 m-0 mt-3">Demo Beyond Inc. Pro <FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" /></Button>
              </Card>
            </Col>
          </Row>
          ...
          <Row>
            <Col md={4}>
              <Navbar.Brand as={HashLink} to="#home" className="me-lg-3 mb-3 d-flex align-items-center">
                <Image src={ReactHero} />
                <span className="ms-2 brand-text">Beyond Inc.</span>
              </Navbar.Brand>
              <p>Beyond Inc. is a free and open source admin dashboard template powered by React.js and Bootstrap 5.</p>
            </Col>
