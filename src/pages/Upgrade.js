        ...
        <>
            <Row className="mt-lg-5 mt-4 d-flex justify-content-center">
                <Col xl={8}>
                    ...
                    <p className="text-center lead mb-lg-5 mb-4">Looking to take React development to the next level? Check out the premium version of Beyond Inc. Dashboard.</p>
                    <Table className="comparison-table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="border-0">
                                    <Button href="https://demo.themesberg.com/volt-pro-react/#/" target="_blank" variant="secondary" className="m-0 mt-3">Demo Beyond Inc. Pro <FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" /></Button>
                                </td>
                            </tr>
                        </tbody>
                    </Table>
