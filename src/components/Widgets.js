  ...
  return (
    <Card border="light" className="shadow-sm">
      ...
      <Card.Body>
        ...
        <Progress title="Quarterly Debt Consolidation Target" color="purple" icon={faBootstrap} percentage={34} />
        <Progress title="Outbound Communications Revamp (Twilio)" color="danger" icon={faAngular} percentage={60} />
        <Progress title="Website Re-design. This one is terrible." color="tertiary" icon={faVuejs} percentage={45} />
        <Progress title="Hiring" color="info" icon={faReact} percentage={35} />
